...
max_prijs = st.sidebar.slider('Maximale prijs', 0,800)
...
df_gem_prijs = df_sidebar.loc[df_sidebar.neighboorhood.isin(plot_data)]
gemiddelde_prijs = df_gem_prijs.price.mean()

df_total_listing = df_sidebar.loc[df_sidebar.neighboorhood.isin(plot_data)]
